...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fill.autotvin.dat"
	set constFileTvOut       "fill.autotvout.dat"
	set constFileHdlTvIn     "fill.autohdltvin.dat"
	set constFileHdlTvOut    "fill.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
