...
set IPName      "fill"
set Version     "1.1"
set DisplayName "Fill"
set Revision    "1611262232"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 a W 0x0 "Data signal of a" {{0 32 a W 0 "Bit 31 to 0 Data signal of a"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 101 II x}
...
set enable_xo_gen 0
set kernel_files {/home/raph/zed-design/hls_array/solution1/top.cpp}
if {$enable_xo_gen} {
