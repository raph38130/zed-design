...
typedef struct {
    ...
    XFill_uio_map maps[ MAX_UIO_MAPS ];
} XFill_uio_info;

/***************** Variable Definitions **************************************/
static XFill_uio_info uio_info;
...
static int uio_info_read_name(XFill_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XFill_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XFill_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XFill_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XFill_Initialize(XFill *InstancePtr, const char* InstanceName) {
	XFill_uio_info *InfoPtr = &uio_info;
