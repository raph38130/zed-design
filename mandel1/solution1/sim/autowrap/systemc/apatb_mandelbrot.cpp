...
// wrapc file define: "cx"
#define AUTOTB_TVIN_cx  "../tv/cdatafile/c.mandelbrot.autotvin_cx.dat"
// wrapc file define: "cy"
#define AUTOTB_TVIN_cy  "../tv/cdatafile/c.mandelbrot.autotvin_cy.dat"
// wrapc file define: "ap_return"
#define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.mandelbrot.autotvout_ap_return.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "ap_return"
#define AUTOTB_TVOUT_PC_ap_return  "../tv/rtldatafile/rtl.mandelbrot.autotvout_ap_return.dat"
...
class INTER_TCL_FILE {
	public:
		...
		string get_depth_list () {
			...
			total_list << "{cx " << cx_depth << "}\n";
			total_list << "{cy " << cy_depth << "}\n";
...
int cy)
{
	...
	else
	{
		...
		// "cx"
		char* tvin_cx = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_cx);

		// "cy"
		char* tvin_cy = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_cy);
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_cx, "%s\n", (cx_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_cx, tvin_cx);
		}

		tcl_file.set_num(1, &tcl_file.cx_depth);
		sprintf(tvin_cx, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_cx, tvin_cx);
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_cy, "%s\n", (cy_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_cy, tvin_cy);
		}

		tcl_file.set_num(1, &tcl_file.cy_depth);
		sprintf(tvin_cy, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_cy, tvin_cy);
...
// [call_c_dut] ---------->
		...
		// release memory allocation: "cx"
		delete [] tvin_cx;
		// release memory allocation: "cy"
		delete [] tvin_cy;
