...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mandelbrot.autotvin.dat"
	set constFileTvOut       "mandelbrot.autotvout.dat"
	set constFileHdlTvIn     "mandelbrot.autohdltvin.dat"
	set constFileHdlTvOut    "mandelbrot.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
