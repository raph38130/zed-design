...
#ifndef __mandelbrot_dadddsbkb__HH__
#define __mandelbrot_dadddsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mandelbrot_dadddsbkb) {
    ...
    SC_CTOR(mandelbrot_dadddsbkb):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
