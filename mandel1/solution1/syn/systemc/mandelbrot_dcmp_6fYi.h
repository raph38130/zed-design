...
#ifndef __mandelbrot_dcmp_6fYi__HH__
#define __mandelbrot_dcmp_6fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mandelbrot_dcmp_6fYi) {
    ...
    SC_CTOR(mandelbrot_dcmp_6fYi):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
