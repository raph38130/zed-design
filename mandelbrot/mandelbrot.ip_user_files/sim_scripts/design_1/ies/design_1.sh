...
bfm_lib_dir="/opt/Xilinx/Vivado/2016.3/lib/lnx64.o"
...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../mandelbrot.srcs/sources_1/bd/design_1/ipshared/2527/hdl" \
       +incdir+"$ref_dir/../../../../mandelbrot.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       +incdir+"../../../../mandelbrot.srcs/sources_1/bd/design_1/ipshared/2527/hdl" \
       +incdir+"../../../../mandelbrot.srcs/sources_1/bd/design_1/ipshared/7e3a/hdl" \
       -loadvpi "$bfm_lib_dir/libxil_ncsim.so:xilinx_register_systf"
}
