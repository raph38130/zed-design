...
// wrapc file define: "p"
#define AUTOTB_TVOUT_p  "../tv/cdatafile/c.add.autotvout_p.dat"
...
// tvout file define: "p"
#define AUTOTB_TVOUT_PC_p  "../tv/rtldatafile/rtl.add.autotvout_p.dat"
...
int* p)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *p_pc_buffer = new sc_bv<32>[1];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: p
				{
					...
					// {
						// celement: p(31, 0)
						// {
							sc_lv<32>* p_lv0_0_0_1 = new sc_lv<32>[1];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: p(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								{
									p_lv0_0_0_1[hls_map_index++].range(31, 0) = sc_bv<32>(p_pc_buffer[hls_map_index].range(31, 0));
								}
							}
						}
					}
					...
					// bitslice(31, 0)
					{
						...
						// celement: p(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								// output_type_conversion : (p_lv0_0_0_1[hls_map_index++]).to_uint64()
								if (&(p[0]) != NULL) // check the null address if the c port is array or others
								{
									p[i_0] = (p_lv0_0_0_1[hls_map_index++]).to_uint64();
								}
							}
						}
					}
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* p_tvout_wrapc_buffer = new sc_bv<32>[1];
