...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "add.autotvin.dat"
	set constFileTvOut       "add.autotvout.dat"
	set constFileHdlTvIn     "add.autohdltvin.dat"
	set constFileHdlTvOut    "add.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
