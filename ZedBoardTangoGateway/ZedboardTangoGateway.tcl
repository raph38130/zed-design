...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS_2 {1} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_DOUT_DEFAULT {0x0000005f} CONFIG.C_GPIO2_WIDTH {8} CONFIG.C_GPIO_WIDTH {8} CONFIG.C_IS_DUAL {1} CONFIG.GPIO2_BOARD_INTERFACE {sws_8bits} CONFIG.GPIO_BOARD_INTERFACE {leds_8bits}  ] $axi_gpio_0
