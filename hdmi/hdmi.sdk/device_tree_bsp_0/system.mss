...
BEGIN DRIVER
 ...
 PARAMETER compatible = xlnx,axi-clkgen-1.0
 PARAMETER reg = 0x79000000 0x10000
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER HW_INSTANCE = axi_hdmi_core
 PARAMETER compatible = xlnx,axi-hdmi-tx-1.0
 PARAMETER reg = 0x70e00000 0x10000
END
...
BEGIN DRIVER
 ...
 PARAMETER compatible = xlnx,axi-i2s-adi-1.0
 PARAMETER reg = 0x77600000 0x10000
END
