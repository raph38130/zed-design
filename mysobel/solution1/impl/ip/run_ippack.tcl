...
set Version     "1.0"
set DisplayName "Image_filter"
set Revision    "1612031652"
set Description "xapp1167 sobel"
set Device      "zynq"
...
set Interfaces {
    s_axi_CONTROL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x14 rows W 0x0 "Data signal of rows" {{0 32 rows W 0 "Bit 31 to 0 Data signal of rows"}}} {0x1c cols W 0x0 "Data signal of cols" {{0 32 cols W 0 "Bit 31 to 0 Data signal of cols"}}} {0x24 C_XR0C0 W 0x0 "Data signal of C_XR0C0" {{0 32 C_XR0C0 W 0 "Bit 31 to 0 Data signal of C_XR0C0"}}} {0x2c C_XR0C1 W 0x0 "Data signal of C_XR0C1" {{0 32 C_XR0C1 W 0 "Bit 31 to 0 Data signal of C_XR0C1"}}} {0x34 C_XR0C2 W 0x0 "Data signal of C_XR0C2" {{0 32 C_XR0C2 W 0 "Bit 31 to 0 Data signal of C_XR0C2"}}} {0x3c C_XR1C0 W 0x0 "Data signal of C_XR1C0" {{0 32 C_XR1C0 W 0 "Bit 31 to 0 Data signal of C_XR1C0"}}} {0x44 C_XR1C1 W 0x0 "Data signal of C_XR1C1" {{0 32 C_XR1C1 W 0 "Bit 31 to 0 Data signal of C_XR1C1"}}} {0x4c C_XR1C2 W 0x0 "Data signal of C_XR1C2" {{0 32 C_XR1C2 W 0 "Bit 31 to 0 Data signal of C_XR1C2"}}} {0x54 C_XR2C0 W 0x0 "Data signal of C_XR2C0" {{0 32 C_XR2C0 W 0 "Bit 31 to 0 Data signal of C_XR2C0"}}} {0x5c C_XR2C1 W 0x0 "Data signal of C_XR2C1" {{0 32 C_XR2C1 W 0 "Bit 31 to 0 Data signal of C_XR2C1"}}} {0x64 C_XR2C2 W 0x0 "Data signal of C_XR2C2" {{0 32 C_XR2C2 W 0 "Bit 31 to 0 Data signal of C_XR2C2"}}} {0x6c C_YR0C0 W 0x0 "Data signal of C_YR0C0" {{0 32 C_YR0C0 W 0 "Bit 31 to 0 Data signal of C_YR0C0"}}} {0x74 C_YR0C1 W 0x0 "Data signal of C_YR0C1" {{0 32 C_YR0C1 W 0 "Bit 31 to 0 Data signal of C_YR0C1"}}} {0x7c C_YR0C2 W 0x0 "Data signal of C_YR0C2" {{0 32 C_YR0C2 W 0 "Bit 31 to 0 Data signal of C_YR0C2"}}} {0x84 C_YR1C0 W 0x0 "Data signal of C_YR1C0" {{0 32 C_YR1C0 W 0 "Bit 31 to 0 Data signal of C_YR1C0"}}} {0x8c C_YR1C1 W 0x0 "Data signal of C_YR1C1" {{0 32 C_YR1C1 W 0 "Bit 31 to 0 Data signal of C_YR1C1"}}} {0x94 C_YR1C2 W 0x0 "Data signal of C_YR1C2" {{0 32 C_YR1C2 W 0 "Bit 31 to 0 Data signal of C_YR1C2"}}} {0x9c C_YR2C0 W 0x0 "Data signal of C_YR2C0" {{0 32 C_YR2C0 W 0 "Bit 31 to 0 Data signal of C_YR2C0"}}} {0xa4 C_YR2C1 W 0x0 "Data signal of C_YR2C1" {{0 32 C_YR2C1 W 0 "Bit 31 to 0 Data signal of C_YR2C1"}}} {0xac C_YR2C2 W 0x0 "Data signal of C_YR2C2" {{0 32 C_YR2C2 W 0 "Bit 31 to 0 Data signal of C_YR2C2"}}} {0xb4 c_high_thresh W 0x0 "Data signal of c_high_thresh" {{0 32 c_high_thresh W 0 "Bit 31 to 0 Data signal of c_high_thresh"}}} {0xbc c_low_thresh W 0x0 "Data signal of c_low_thresh" {{0 32 c_low_thresh W 0 "Bit 31 to 0 Data signal of c_low_thresh"}}} {0xc4 c_invert W 0x0 "Data signal of c_invert" {{0 32 c_invert W 0 "Bit 31 to 0 Data signal of c_invert"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS video_in video_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency undef II x}
...
set enable_xo_gen 0
set kernel_files {/home/raph/zed-design/mysobel/solution1/top.cpp}
if {$enable_xo_gen} {
