...
typedef struct {
    ...
    XImage_filter_uio_map maps[ MAX_UIO_MAPS ];
} XImage_filter_uio_info;

/***************** Variable Definitions **************************************/
static XImage_filter_uio_info uio_info;
...
static int uio_info_read_name(XImage_filter_uio_info* info) {
...
static int uio_info_read_map_addr(XImage_filter_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XImage_filter_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
