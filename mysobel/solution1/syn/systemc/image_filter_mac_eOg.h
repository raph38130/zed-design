...
#ifndef __image_filter_mac_eOg__HH__
#define __image_filter_mac_eOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_eOg) {
    ...
    SC_CTOR(image_filter_mac_eOg):  simcore_mac_0_U ("simcore_mac_0_U") {
