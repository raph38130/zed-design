...
#ifndef __image_filter_mac_fYi__HH__
#define __image_filter_mac_fYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_fYi) {
    ...
    SC_CTOR(image_filter_mac_fYi):  simcore_mac_1_U ("simcore_mac_1_U") {
