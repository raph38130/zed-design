...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_BASEADDR {0x00000000} CONFIG.C_DMA_TYPE {1} CONFIG.C_HIGHADDR {0xffffffff} CONFIG.C_S_AXI_ADDR_WIDTH {16}  ] $axi_i2s_adi
